...
## Used group_by function to select “Subject” and “Activity” variables to be able to summarize the average results of the variables per the subject’s activity type. 
